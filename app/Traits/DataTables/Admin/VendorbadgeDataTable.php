...
trait VendorbadgeDataTable
{
    ...
    public static function dataTableEditColumns($table)
    {
        ...
        $viewAllPermission = Auth::user()->hasPermissionTo('view_all vendorbadges');
        $viewOwnPermission = Auth::user()->hasPermissionTo('view_own vendorbadges');
        $updateAllPermission = Auth::user()->hasPermissionTo('update_all vendorbadges');
        $updateOwnPermission = Auth::user()->hasPermissionTo('update_own vendorbadges');
        $deleteAllPermission = Auth::user()->hasPermissionTo('delete_all vendorbadges');
        $deleteOwnPermission = Auth::user()->hasPermissionTo('delete_own vendorbadges');
