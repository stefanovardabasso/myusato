...
trait CmsDataTable
{
    ...
    public static function dataTableEditColumns($table)
    {
        ...
        $viewAllPermission = Auth::user()->hasPermissionTo('view_all cmss');
        $viewOwnPermission = Auth::user()->hasPermissionTo('view_own cmss');
        $updateAllPermission = Auth::user()->hasPermissionTo('update_all cmss');
        $updateOwnPermission = Auth::user()->hasPermissionTo('update_own cmss');
        $deleteAllPermission = Auth::user()->hasPermissionTo('delete_all cmss');
        $deleteOwnPermission = Auth::user()->hasPermissionTo('delete_own cmss');
    ...
    public static function getDataTableObject($tableId, $route)
    {
        return [
            ...
            'columns' => [
                ...
                [
                    'data' => 'name', 'className' => 'dt_col_name', 'label' => 'Nome',
                    'filter' => [ 'type' => "search" ]
                ],
                [
                    'data' => 'url', 'className' => 'dt_col_url', 'label' => 'SEO URL',
                    'filter' => [ 'type' => "search" ]
                ],
