...
trait GalleryDataTable
{
    ...
    public static function dataTableEditColumns($table)
    {
        ...
        $viewAllPermission = Auth::user()->hasPermissionTo('view_all gallerys');
        $viewOwnPermission = Auth::user()->hasPermissionTo('view_own gallerys');
        $updateAllPermission = Auth::user()->hasPermissionTo('update_all gallerys');
        $updateOwnPermission = Auth::user()->hasPermissionTo('update_own gallerys');
        $deleteAllPermission = Auth::user()->hasPermissionTo('delete_all gallerys');
        $deleteOwnPermission = Auth::user()->hasPermissionTo('delete_own gallerys');
