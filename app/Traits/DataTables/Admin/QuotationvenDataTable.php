...
trait QuotationvenDataTable
{
    ...
    public static function dataTableEditColumns($table)
    {
        ...
        $viewAllPermission = Auth::user()->hasPermissionTo('view_all quotationvens');
        $viewOwnPermission = Auth::user()->hasPermissionTo('view_own quotationvens');
        $updateAllPermission = Auth::user()->hasPermissionTo('update_all quotationvens');
        $updateOwnPermission = Auth::user()->hasPermissionTo('update_own quotationvens');
        $deleteAllPermission = Auth::user()->hasPermissionTo('delete_all quotationvens');
        $deleteOwnPermission = Auth::user()->hasPermissionTo('delete_own quotationvens');
    ...
    public static function getDataTableObject($tableId, $route)
    {
        return [
            ...
            'columns' => [
                ...
                [
                    'data' => 'user_id', 'className' => 'dt_col_user_id', 'label' => self::getAttrsTrans('user_id'),
                    'filter' => [ 'type' => "search" ]
                ],
            ],
            'ajax' => [
