...
trait Questions_filterDataTable
{
    use DataTable;
    ...
    public static function dataTableEditColumns($table)
    {
        ...
        $viewAllPermission = Auth::user()->hasPermissionTo('view_all questions_filters');
        $viewOwnPermission = Auth::user()->hasPermissionTo('view_own questions_filters');
        $updateAllPermission = Auth::user()->hasPermissionTo('update_all questions_filters');
        $updateOwnPermission = Auth::user()->hasPermissionTo('update_own questions_filters');
        $deleteAllPermission = Auth::user()->hasPermissionTo('delete_all questions_filters');
        $deleteOwnPermission = Auth::user()->hasPermissionTo('delete_own questions_filters');
        ...
        $table->editColumn('actions', function ($row) use($viewAllPermission, $viewOwnPermission, $updateAllPermission, $updateOwnPermission, $deleteAllPermission, $deleteOwnPermission) {
            $routeKey = 'admin.questions_filters';
