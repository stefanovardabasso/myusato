...
trait PlaceDataTable
{
    ...
    public static function dataTableEditColumns($table)
    {
        ...
        $viewAllPermission = Auth::user()->hasPermissionTo('view_all places');
        $viewOwnPermission = Auth::user()->hasPermissionTo('view_own places');
        $updateAllPermission = Auth::user()->hasPermissionTo('update_all places');
        $updateOwnPermission = Auth::user()->hasPermissionTo('update_own places');
        $deleteAllPermission = Auth::user()->hasPermissionTo('delete_all places');
        $deleteOwnPermission = Auth::user()->hasPermissionTo('delete_own places');
