...
trait VendorplaceDataTable
{
    ...
    public static function dataTableEditColumns($table)
    {
        ...
        $viewAllPermission = Auth::user()->hasPermissionTo('view_all vendorplaces');
        $viewOwnPermission = Auth::user()->hasPermissionTo('view_own vendorplaces');
        $updateAllPermission = Auth::user()->hasPermissionTo('update_all vendorplaces');
        $updateOwnPermission = Auth::user()->hasPermissionTo('update_own vendorplaces');
        $deleteAllPermission = Auth::user()->hasPermissionTo('delete_all vendorplaces');
        $deleteOwnPermission = Auth::user()->hasPermissionTo('delete_own vendorplaces');
