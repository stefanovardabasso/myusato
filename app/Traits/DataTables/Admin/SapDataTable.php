...
trait SapDataTable
{
    ...
    public static function dataTableEditColumns($table)
    {
        ...
        $viewAllPermission = Auth::user()->hasPermissionTo('view_all saps');
        $viewOwnPermission = Auth::user()->hasPermissionTo('view_own saps');
        $updateAllPermission = Auth::user()->hasPermissionTo('update_all saps');
        $updateOwnPermission = Auth::user()->hasPermissionTo('update_own saps');
        $deleteAllPermission = Auth::user()->hasPermissionTo('delete_all saps');
        $deleteOwnPermission = Auth::user()->hasPermissionTo('delete_own saps');
    ...
    public static function getDataTableObject($tableId, $route)
    {
        return [
            ...
            'columns' => [
                ...
                [
                    'data' => 'date', 'className' => 'dt_col_date', 'label' => self::getAttrsTrans('date'),
                    'filter' => [ 'type' => "search" ]
                ],
            ],
            'ajax' => [
