...
trait MymachineDataTable
{
    ...
    public static function dataTableEditColumns($table)
    {
        ...
        $viewAllPermission = Auth::user()->hasPermissionTo('view_all mymachines');
        $viewOwnPermission = Auth::user()->hasPermissionTo('view_own mymachines');
        $updateAllPermission = Auth::user()->hasPermissionTo('update_all mymachines');
        $updateOwnPermission = Auth::user()->hasPermissionTo('update_own mymachines');
        $deleteAllPermission = Auth::user()->hasPermissionTo('delete_all mymachines');
        $deleteOwnPermission = Auth::user()->hasPermissionTo('delete_own mymachines');
    ...
    public static function getDataTableObject($tableId, $route)
    {
        return [
            ...
            'columns' => [
                ...
                [
                    'data' => 'id_offert', 'className' => 'dt_col_id_offert', 'label' => self::getAttrsTrans('id_offert'),
                    'filter' => [ 'type' => "search" ]
                ],
            ],
            'ajax' => [
