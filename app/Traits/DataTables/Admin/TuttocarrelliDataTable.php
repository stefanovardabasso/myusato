...
trait TuttocarrelliDataTable
{
    ...
    public static function dataTableEditColumns($table)
    {
        ...
        $viewAllPermission = Auth::user()->hasPermissionTo('view_all tuttocarrellis');
        $viewOwnPermission = Auth::user()->hasPermissionTo('view_own tuttocarrellis');
        $updateAllPermission = Auth::user()->hasPermissionTo('update_all tuttocarrellis');
        $updateOwnPermission = Auth::user()->hasPermissionTo('update_own tuttocarrellis');
        $deleteAllPermission = Auth::user()->hasPermissionTo('delete_all tuttocarrellis');
        $deleteOwnPermission = Auth::user()->hasPermissionTo('delete_own tuttocarrellis');
