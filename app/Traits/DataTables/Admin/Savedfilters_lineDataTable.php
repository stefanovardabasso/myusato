...
trait Savedfilters_lineDataTable
{
    use DataTable;
    ...
    public static function dataTableEditColumns($table)
    {
        ...
        $viewAllPermission = Auth::user()->hasPermissionTo('view_all savedfilters_lines');
        $viewOwnPermission = Auth::user()->hasPermissionTo('view_own savedfilters_lines');
        $updateAllPermission = Auth::user()->hasPermissionTo('update_all savedfilters_lines');
        $updateOwnPermission = Auth::user()->hasPermissionTo('update_own savedfilters_lines');
        $deleteAllPermission = Auth::user()->hasPermissionTo('delete_all savedfilters_lines');
        $deleteOwnPermission = Auth::user()->hasPermissionTo('delete_own savedfilters_lines');
        ...
        $table->editColumn('actions', function ($row) use($viewAllPermission, $viewOwnPermission, $updateAllPermission, $updateOwnPermission, $deleteAllPermission, $deleteOwnPermission) {
            $routeKey = 'admin.savedfilters_lines';
    ...
    public static function getDataTableObject($tableId, $route)
    {
        return [
            ...
            'columns' => [
                ...
                [
                    'data' => 'saved_id', 'className' => 'dt_col_saved_id', 'label' => self::getAttrsTrans('saved_id'),
                    'filter' => [ 'type' => "search" ]
                ],
            ],
            'ajax' => [
