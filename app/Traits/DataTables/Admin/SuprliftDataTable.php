...
trait SuprliftDataTable
{
    ...
    public static function dataTableEditColumns($table)
    {
        ...
        $viewAllPermission = Auth::user()->hasPermissionTo('view_all suprlifts');
        $viewOwnPermission = Auth::user()->hasPermissionTo('view_own suprlifts');
        $updateAllPermission = Auth::user()->hasPermissionTo('update_all suprlifts');
        $updateOwnPermission = Auth::user()->hasPermissionTo('update_own suprlifts');
        $deleteAllPermission = Auth::user()->hasPermissionTo('delete_all suprlifts');
        $deleteOwnPermission = Auth::user()->hasPermissionTo('delete_own suprlifts');
