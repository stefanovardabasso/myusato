...
trait Fam_selectDataTable
{
    ...
    public static function dataTableEditColumns($table)
    {
        ...
        $viewAllPermission = Auth::user()->hasPermissionTo('view_all fam_selects');
        $viewOwnPermission = Auth::user()->hasPermissionTo('view_own fam_selects');
        $updateAllPermission = Auth::user()->hasPermissionTo('update_all fam_selects');
        $updateOwnPermission = Auth::user()->hasPermissionTo('update_own fam_selects');
        $deleteAllPermission = Auth::user()->hasPermissionTo('delete_all fam_selects');
        $deleteOwnPermission = Auth::user()->hasPermissionTo('delete_own fam_selects');
    ...
    public static function getDataTableObject($tableId, $route)
    {
        return [
            ...
            'columns' => [
                ...
                [
                    'data' => 'button_id', 'className' => 'dt_col_button_id', 'label' => self::getAttrsTrans('button_id'),
                    'filter' => [ 'type' => "search" ]
                ],
            ],
            'ajax' => [
