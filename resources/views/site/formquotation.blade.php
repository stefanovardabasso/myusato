...
@section('title', __('Quotation form'))
...
<div class="container px-15 md_px-0" style="margin-bottom: 10%; margin-top: 5%">
    ...
    <div class="new-ads mb-30">
        <div class="row-15 flex flex-wrap my-40" style="margin-top: 5%; margin-bottom: 5%">
    ...
    <form class="valuta-form" method="POST" action="{{route('addtoquotation')}}">
