...
@section('title', $suprlift::getMsgTrans('view_heading'))

@section('content')
    @include('partials._content-heading', ['title' => $suprlift::getMsgTrans('view_heading')])
            ...
            <div class="row">
                <div class="col-md-12">
                    <table class="table table-bordered table-striped">
                        <tr>
                            <th>{{ $suprlift::getAttrsTrans('offert_id') }}</th>
                            <td field-key='offert_id'>{{ $suprlift->offert_id }}</td>
                        </tr>
                    </table>
                </div>
            </div>
