...
@section('title', $sap::getMsgTrans('view_heading'))

@section('content')
    @include('partials._content-heading', ['title' => $sap::getMsgTrans('view_heading')])
            ...
            <div class="row">
                <div class="col-md-12">
                    <table class="table table-bordered table-striped">
                        <tr>
                            <th>{{ $sap::getAttrsTrans('date') }}</th>
                            <td field-key='date'>{{ $sap->date }}</td>
                        </tr>
                    </table>
                </div>
            </div>
