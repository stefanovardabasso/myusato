...
@section('title', $questions_filters_traduction::getMsgTrans('view_heading'))

@section('content')
    @include('partials._content-heading', ['title' => $questions_filters_traduction::getMsgTrans('view_heading')])
            ...
            <div class="row">
                <div class="col-md-12">
                    <table class="table table-bordered table-striped">
                        <tr>
                            <th>{{ $questions_filters_traduction::getAttrsTrans('cod_fam') }}</th>
                            <td field-key='cod_fam'>{{ $questions_filters_traduction->cod_fam }}</td>
                        </tr>
                    </table>
                </div>
            </div>
