...
@section('title', $quotationvens_line::getMsgTrans('view_heading'))

@section('content')
    @include('partials._content-heading', ['title' => $quotationvens_line::getMsgTrans('view_heading')])
            ...
            <div class="row">
                <div class="col-md-12">
                    <table class="table table-bordered table-striped">
                        <tr>
                            <th>{{ $quotationvens_line::getAttrsTrans('id_quotationven') }}</th>
                            <td field-key='id_quotationven'>{{ $quotationvens_line->id_quotationven }}</td>
                        </tr>
                    </table>
                </div>
            </div>
