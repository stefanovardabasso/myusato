...
@section('title', $products_line::getMsgTrans('view_heading'))

@section('content')
    @include('partials._content-heading', ['title' => $products_line::getMsgTrans('view_heading')])
            ...
            <div class="row">
                <div class="col-md-12">
                    <table class="table table-bordered table-striped">
                        <tr>
                            <th>{{ $products_line::getAttrsTrans('id_product') }}</th>
                            <td field-key='id_product'>{{ $products_line->id_product }}</td>
                        </tr>
                    </table>
                </div>
            </div>
