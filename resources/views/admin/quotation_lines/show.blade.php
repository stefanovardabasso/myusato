...
@section('title', $quotation_line::getMsgTrans('view_heading'))

@section('content')
    @include('partials._content-heading', ['title' => $quotation_line::getMsgTrans('view_heading')])
            ...
            <div class="row">
                <div class="col-md-12">
                    <table class="table table-bordered table-striped">
                        <tr>
                            <th>{{ $quotation_line::getAttrsTrans('id_quotation') }}</th>
                            <td field-key='id_quotation'>{{ $quotation_line->id_quotation }}</td>
                        </tr>
                    </table>
                </div>
            </div>
