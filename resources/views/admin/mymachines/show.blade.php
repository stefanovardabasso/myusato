...
@section('title', $mymachine::getMsgTrans('view_heading'))

@section('content')
    @include('partials._content-heading', ['title' => $mymachine::getMsgTrans('view_heading')])
            ...
            <div class="row">
                <div class="col-md-12">
                    <table class="table table-bordered table-striped">
                        <tr>
                            <th>{{ $mymachine::getAttrsTrans('id_offert') }}</th>
                            <td field-key='id_offert'>{{ $mymachine->id_offert }}</td>
                        </tr>
                    </table>
                </div>
            </div>
