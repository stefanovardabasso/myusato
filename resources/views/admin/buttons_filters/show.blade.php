...
@section('title', $buttons_filter::getMsgTrans('view_heading'))

@section('content')
    @include('partials._content-heading', ['title' => $buttons_filter::getMsgTrans('view_heading')])
            ...
            <div class="row">
                <div class="col-md-12">
                    <table class="table table-bordered table-striped">
                        <tr>
                            <th>{{ $buttons_filter::getAttrsTrans('button_it') }}</th>
                            <td field-key='button_it'>{{ $buttons_filter->button_it }}</td>
                        </tr>
                    </table>
                </div>
            </div>
