...
@section('title', $cms::getMsgTrans('view_heading'))

@section('content')
    @include('partials._content-heading', ['title' => $cms::getMsgTrans('view_heading')])
            ...
            <div class="row">
                <div class="col-md-12">
                    <table class="table table-bordered table-striped">
                        <tr>
                            <th>{{ $cms::getAttrsTrans('name') }}</th>
                            <td field-key='name'>{{ $cms->name }}</td>
                        </tr>
                    </table>
                </div>
            </div>
